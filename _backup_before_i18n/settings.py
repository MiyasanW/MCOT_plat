...
DATABASES = {
    'default': {
        ...
        'NAME': BASE_DIR / os.environ.get('DB_NAME', 'db_mock.sqlite3'),
    }
}
...
# --- Jazzmin Settings ---
JAZZMIN_SETTINGS = {
    "site_title": "MCOT Rental",
    "site_header": "MCOT Rental",
    "site_brand": "MCOT Rental",
    "welcome_sign": "Welcome to MCOT Rental Admin",
    "search_model": ["store.Booking", "store.Product"],
    "show_sidebar": True,
    "navigation_expanded": True,
    "icons": {
        "store.Booking": "fas fa-calendar-check",
        "store.Product": "fas fa-box",
        "store.Equipment": "fas fa-camera",
    ...
    # Hide these models from the main menu

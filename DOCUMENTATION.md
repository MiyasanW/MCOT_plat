# เอกสารเทคนิคระบบ MCOT Equipment Service (ปรับปรุงล่าสุด)
...
MCOT Equipment Service เป็นระบบจองอุปกรณ์ สตูดิโอ และแพ็กเกจ สำหรับทั้งลูกค้าภายนอกและทีมงานภายใน โดย flow หลักคือ:
